...
Usart_DataTypeDef* loggingUsart = &usart1; // 日志输出使用的串口
...
Usart_DataTypeDef* servoUsart = &usart2; // 跟舵机DBSP主板通信的串口
#endif
...
Usart_DataTypeDef* loggingUsart = &usart3;
#endif
